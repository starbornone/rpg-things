...
const styles = {
  ...
  outline: [
    ...
    // Icon
    '[--btn-icon:theme(colors.gray.500)] data-[active]:[--btn-icon:theme(colors.gray.700)] data-[hover]:[--btn-icon:theme(colors.gray.700)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[hover]:[--btn-icon:theme(colors.gray.400)]',
  ],
  plain: [
    // Base
    ...
    // Icon
    '[--btn-icon:theme(colors.gray.500)] data-[active]:[--btn-icon:theme(colors.gray.700)] data-[hover]:[--btn-icon:theme(colors.gray.700)] dark:[--btn-icon:theme(colors.gray.500)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[hover]:[--btn-icon:theme(colors.gray.400)]',
  ],
  colors: {
    'dark/gray': [
      'text-white [--btn-bg:theme(colors.gray.900)] [--btn-border:theme(colors.gray.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:text-white dark:[--btn-bg:theme(colors.gray.600)] dark:[--btn-hover-overlay:theme(colors.white/5%)]',
      '[--btn-icon:theme(colors.gray.400)] data-[active]:[--btn-icon:theme(colors.gray.300)] data-[hover]:[--btn-icon:theme(colors.gray.300)]',
    ],
    light: [
      'text-gray-950 [--btn-bg:white] [--btn-border:theme(colors.gray.950/10%)] [--btn-hover-overlay:theme(colors.gray.950/2.5%)] data-[active]:[--btn-border:theme(colors.gray.950/15%)] data-[hover]:[--btn-border:theme(colors.gray.950/15%)]',
      'dark:text-white dark:[--btn-hover-overlay:theme(colors.white/5%)] dark:[--btn-bg:theme(colors.gray.800)]',
      '[--btn-icon:theme(colors.gray.500)] data-[active]:[--btn-icon:theme(colors.gray.700)] data-[hover]:[--btn-icon:theme(colors.gray.700)] dark:[--btn-icon:theme(colors.gray.500)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[hover]:[--btn-icon:theme(colors.gray.400)]',
    ],
    'dark/white': [
      'text-white [--btn-bg:theme(colors.gray.900)] [--btn-border:theme(colors.gray.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:text-gray-950 dark:[--btn-bg:white] dark:[--btn-hover-overlay:theme(colors.gray.950/5%)]',
      '[--btn-icon:theme(colors.gray.400)] data-[active]:[--btn-icon:theme(colors.gray.300)] data-[hover]:[--btn-icon:theme(colors.gray.300)] dark:[--btn-icon:theme(colors.gray.500)] dark:data-[active]:[--btn-icon:theme(colors.gray.400)] dark:data-[hover]:[--btn-icon:theme(colors.gray.400)]',
    ],
    dark: [
      'text-white [--btn-bg:theme(colors.gray.900)] [--btn-border:theme(colors.gray.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'dark:[--btn-hover-overlay:theme(colors.white/5%)] dark:[--btn-bg:theme(colors.gray.800)]',
      '[--btn-icon:theme(colors.gray.400)] data-[active]:[--btn-icon:theme(colors.gray.300)] data-[hover]:[--btn-icon:theme(colors.gray.300)]',
    ],
    white: [
      'text-gray-950 [--btn-bg:white] [--btn-border:theme(colors.gray.950/10%)] [--btn-hover-overlay:theme(colors.gray.950/2.5%)] data-[active]:[--btn-border:theme(colors.gray.950/15%)] data-[hover]:[--btn-border:theme(colors.gray.950/15%)]',
      'dark:[--btn-hover-overlay:theme(colors.gray.950/5%)]',
      '[--btn-icon:theme(colors.gray.400)] data-[active]:[--btn-icon:theme(colors.gray.500)] data-[hover]:[--btn-icon:theme(colors.gray.500)]',
    ],
    gray: [
...
export const Button = forwardRef(function Button(
  ...
  let classes = clsx(
    className,
    styles.base,
    outline ? styles.outline : plain ? styles.plain : clsx(styles.solid, styles.colors[color ?? 'dark/gray'])
  );
