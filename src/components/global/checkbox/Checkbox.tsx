import { CheckboxProps, Checkbox as CheckboxWrapper, Field, FieldProps } from '@headlessui/react';
...
export function CheckboxField({ className, ...props }: { className?: string } & Omit<FieldProps, 'as' | 'className'>) {
  return (
    <Field
      data-slot="field"
      {...props}
...
const base = [
  ...
  // Border
  'border border-gray-950/15 group-data-[checked]:border-transparent group-data-[checked]:group-data-[hover]:border-transparent group-data-[hover]:border-gray-950/30 group-data-[checked]:bg-[--checkbox-checked-border]',
  ...
  'group-data-[disabled]:border-gray-950/25 group-data-[disabled]:bg-gray-950/5 group-data-[disabled]:[--checkbox-check:theme(colors.gray.950/50%)] group-data-[disabled]:before:bg-transparent',
...
const colors = {
  'dark/gray': [
    '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.gray.900)] [--checkbox-checked-border:theme(colors.gray.950/90%)]',
    'dark:[--checkbox-checked-bg:theme(colors.gray.600)]',
  ],
  'dark/white': [
    '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.gray.900)] [--checkbox-checked-border:theme(colors.gray.950/90%)]',
    'dark:[--checkbox-check:theme(colors.gray.900)] dark:[--checkbox-checked-bg:theme(colors.white)] dark:[--checkbox-checked-border:theme(colors.gray.950/15%)]',
  ],
  white:
    '[--checkbox-check:theme(colors.gray.900)] [--checkbox-checked-bg:theme(colors.white)] [--checkbox-checked-border:theme(colors.gray.950/15%)]',
  dark: '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.gray.900)] [--checkbox-checked-border:theme(colors.gray.950/90%)]',
  gray: '[--checkbox-check:theme(colors.white)] [--checkbox-checked-bg:theme(colors.gray.600)] [--checkbox-checked-border:theme(colors.gray.700/90%)]',
...
export function Checkbox({
  ...
  return (
    <CheckboxWrapper data-slot="control" {...props} className={clsx(className, 'group inline-flex focus:outline-none')}>
